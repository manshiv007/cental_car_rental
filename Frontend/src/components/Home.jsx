                                        ...
                                        <div className="row g-5">
                                            <div className="col-lg-6 d-none d-lg-flex fadeInRight animated" style={{ animationDelay: "1s" }}>
                                                <div className="text-start">
                                                    <h1 className="display-5 text-white">Get 15% off on your first rental! Choose Your Model</h1>
                    ...
                    <div className="row g-5">
                        <div className="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                            <div className="about-item">
                                ...
                                <p className="text-item my-4">We blend experience with innovation to deliver unmatched service, no matter the distance. Our growing fleet, dedicated team, and streamlined rental process are all designed with your journey in mind.</p>
                                <div className="row g-4">
                                    <div className="col-lg-6">
                        ...
                        <div className="categories-item p-4">
                            <div className="categories-item-inner">
                                ...
                                <div className="categories-content rounded-bottom p-4">
                                    ...
                                    <Link to="#" className="btn btn-primary rounded-pill d-flex justify-content-center py-3">Book Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="categories-item p-4">
                        ...
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="blog-item">
                                ...
                                <div className="blog-content rounded-bottom p-4">
                                    ...
                                    <Link to="#" className="h4 d-block mb-3">Rental Cars how to check driving fines?</Link>
                                    <p className="mb-3">
                                    "Seamless experience!"

                                    "Booking a car through Cental was incredibly simple and fast. The car was clean, and the service was top-notch."
                                    — Arjun, Mohali</p>
                                    <Link to="#" className="">Read More  <i className="fa fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="blog-item">
                                ...
                                <div className="blog-content rounded-bottom p-4">
                                    ...
                                    <Link to="#" className="h4 d-block mb-3">Rental cost of sport and other cars</Link>
                                    <p className="mb-3">
                        ...
                        <div className="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="blog-item">
                                ...
                                <div className="blog-content rounded-bottom p-4">
                                    ...
                                    <Link to="#" className="h4 d-block mb-3">Document required for car rental</Link>
                                    <p className="mb-3">
                                    "Affordable & reliable"
            ...
            <div className="container-fluid banner pb-5 wow zoomInDown" data-wow-delay="0.1s">
                <div className="container pb-5">
                    <div className="banner-item rounded">
                        <img src="/assets/img/banner-1.jpg" className="img-fluid rounded w-100" alt="Rent a car banner"/>
                ...
                <div className="container pb-5">
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="team-item p-4 pt-0">
                                <div className="team-img">
                                    <img src="/assets/img/team-1.jpg" className="img-fluid rounded w-100" alt="Martin Ford"/>
                                </div>
                                <div className="team-content pt-4">
                                    <h4>Martin Ford</h4>
                                    <p>Accountant</p>
                                    <div className="team-icon d-flex justify-content-center">
                                        <Link to="#" className="btn btn-square btn-light rounded-circle mx-1"><i className="fab fa-facebook-f"></i></Link>
                                        <Link to="#" className="btn btn-square btn-light rounded-circle mx-1"><i className="fab fa-twitter"></i></Link>
                                        <Link to="#" className="btn btn-square btn-light rounded-circle mx-1"><i className="fab fa-instagram"></i></Link>
                                        <Link to="#" className="btn btn-square btn-light rounded-circle mx-1"><i className="fab fa-linkedin-in"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="team-item p-4 pt-0">
                                <div className="team-img">
                                    <img src="/assets/img/team-2.jpg" className="img-fluid rounded w-100" alt="Dwane Johnson"/>
                                </div>
                                <div className="team-content pt-4">
                                    <h4>Dwane Johnson</h4>
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="team-item p-4 pt-0">
                                <div className="team-img">
                                    <img src="/assets/img/team-3.jpg" className="img-fluid rounded w-100" alt="Jason Sathathm"/>
                                </div>
                                <div className="team-content pt-4">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                            <div className="team-item p-4 pt-0">
                                <div className="team-img">
                                    <img src="/assets/img/team-4.jpg" className="img-fluid rounded w-100" alt="Martin Doe"/>
                                </div>
                                <div className="team-content pt-4">
                                    <h4>Martin Doe</h4>
                                    <p>Manager</p>
                    ...
                    <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                        <div className="testimonial-item">
                            ...
                            <div className="testimonial-inner p-4">
                                <img src="/assets/img/testimonial-1.jpg" className="img-fluid" alt="Agatha"/>
                                <div className="ms-4">
                                    <h4>Agatha</h4>
                                    <p>Profession</p>
                        ...
                        <div className="testimonial-item">
                            <div className="testimonial-quote"><i className="fa fa-quote-right fa-2x"></i></div>
                            <div className="testimonial-inner p-4">
                                <img src="/assets/img/testimonial-2.jpg" className="img-fluid" alt="Wanda"/>
                                <div className="ms-4">
                                    <h4>Wanda</h4>
                                    <p>Profession</p>
                                    <div className="d-flex text-primary">
                        ...
                        <div className="testimonial-item">
                            <div className="testimonial-quote"><i className="fa fa-quote-right fa-2x"></i></div>
                            <div className="testimonial-inner p-4">
                                <img src="/assets/img/testimonial-3.jpg" className="img-fluid" alt="Loki"/>
                                <div className="ms-4">
                                    <h4>Loki</h4>
                                    <p>Profession</p>
                                    <div className="d-flex text-primary">
